...
public class Orders {
    ...
    public void Get_All_order(Context mcontext,int status, final Get_Order listener){
        listener.onstart();
        String url= Store_info.api+"order/"+status;
    ...
    public void Get_All_orderBystore(Context mcontext,String storeID,int status, final Get_Order listener){
        listener.onstart();
        String url= Store_info.api+"order/by_store_And_status/"+Store_info.storeID+"/"+status+"/1";
        RequestQueue queue = Volley.newRequestQueue(mcontext);  // this = context
...
//                        Log.d("Error.Response", error.getMessage());
    ...
    public void Get_All_orderByuser(Context mcontext,String userID,int status, final Get_Order listener){
        listener.onstart();
        String url= Store_info.api+"order/by_user_And_status/"+userID+"/"+status;
        RequestQueue queue = Volley.newRequestQueue(mcontext);  // this = context
    ...
    public void Post_Order(final Context mcontext, final Order order , final Get_Order listener) {
        listener.onstart();
        String url= Store_info.api+"order";
        RequestQueue queue = Volley.newRequestQueue(mcontext);  // this = context
...
// Add the request to the RequestQueue.
    ...
    public void Put_Order_status(final Context mcontext,String orderID, final int status , final Get_Order listener) {
        listener.onstart();
        String url= Store_info.api+"order/"+orderID+"/"+status;
        RequestQueue queue = Volley.newRequestQueue(mcontext);  // this = context
