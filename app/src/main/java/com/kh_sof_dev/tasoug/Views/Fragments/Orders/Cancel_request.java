...
public class Cancel_request extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        com.kh_sof_dev.tasoug.Views.Fragments.Orders.Order.oncancel_listenner=new com.kh_sof_dev.tasoug.Views.Fragments.Orders.Order.onfilter() {
            @RequiresApi(api = Build.VERSION_CODES.O)
            @Override
            public void getDate(String date) {
//                Toast.makeText(getContext(),date+" cancel",Toast.LENGTH_SHORT).show();
    ...
    private List<com.kh_sof_dev.tasoug.Model.Classes.Order> orderList;
