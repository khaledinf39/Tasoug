 ...
 */
public class mabiat extends Fragment implements View.OnClickListener {
...
private ImageView scan_btn;
    ...
    private void initialize(View view) {
        ...
        lay_rest=view.findViewById(R.id.lay_rest);
       /********************************Actions**********************/
       lay_rest.setVisibility(View.GONE);
       tcheck_out.setVisibility(View.GONE);
...
try {
    ...
    private void Add_order() {
        ...
        orders.Post_Order(getContext(), order, new Mostalamat.Get_Order() {
            @Override
            public void onstart() {
