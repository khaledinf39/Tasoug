...
return;
        ...
        upload_img(0, new upload_image() {
            ...
            public void onsucc() {
                ...
                com.kh_sof_dev.tasoug.Controule.Routes.Products products=new Products();
                products.Post_product(Add_product.this,product , new Products.Get_product(){
                    @Override
                    public void onstart() {
    ...
    private void popup_addCategories() {
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Categories categories=new Categories();
                categories.Post_categorie(Add_product.this, categorie_, new Categories.Get_categories() {
                    @Override
                    public void onstart() {
                        progressDialog.show();
                        dialog.dismiss();
    ...
    private void popup_editCategories() {
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setMessage("رفع البيانات...");
                Categories categories=new Categories();
                categories.Put_categorie(Add_product.this,categorieID, categorie_, new Categories.Get_categories() {
                    @Override
                    public void onstart() {
                        dialog.dismiss();
                        progressDialog.show();
